...
Original file is located at
    https://colab.research.google.com/drive/1OHGKRfS208L0u6P5HEWNhEFGmLakrLXS
...
print("Hello " + name + ". Great to see you. Also, your surname is " + surname + ", and your age is " + age)
...
fahrenheit = float(input("Enter fahrenheit to convert it: "))
